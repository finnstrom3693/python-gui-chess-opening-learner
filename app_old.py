...
class OpeningDetector:
    ...
    def _initialize_openings(self) -> Dict[str, ChessOpening]:
        # Predefined chess openings (AI-generated commentary will be used instead of descriptions)
        return {
            "1. e4 e5 2. Nf3": ChessOpening(
                name="King's Pawn Game",
                moves="1. e4 e5 2. Nf3",
                eco_code="C20"
            ),
            "1. e4 e5 2. Nf3 Nc6 3. Bb5": ChessOpening(
                name="Ruy Lopez",
                moves="1. e4 e5 2. Nf3 Nc6 3. Bb5",
                eco_code="C60"
            ),
            "1. e4 c5": ChessOpening(
                name="Sicilian Defense",
                moves="1. e4 c5",
                eco_code="B20"
            ),
            "1. d4 d5": ChessOpening(
                name="Queen's Pawn Game",
                moves="1. d4 d5",
                eco_code="D00"
            ),
            "1. e4 e5 2. Nf3 Nc6 3. Bc4": ChessOpening(
                name="Italian Game",
